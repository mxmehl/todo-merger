...
Starting development is as easy as installing [`uv`](https://github.com/astral-sh/uv) and running `uv sync` once.

In order to run the project in the new virtual environment, run `uv run todo-merger`.
